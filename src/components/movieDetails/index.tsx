                ...
                <div className="details--left">
                  {trailerData ? (
                    ...
                    <div className="details--right">
                      ...
                      <span>
                        <span>{movieData.certification  ? (
                          <strong className='classification'>{movieData.certification}</strong> 
                        ) : ('') } ({movieData.original_language}) {getYear(movieData.release_date)} | {movieData.runtime ? `${movieData.runtime} minutos` : ''}</span>
                      </span>
                      <br />
                      ...
                      {movieData.watchProviders.results.BR?.flatrate ? (
                        <>
                          ...
                          <ul className='providers--area'>
                            {movieData?.watchProviders.results.BR?.flatrate?.map((item, index) => (
